...
def update_post_cert_details(response, domain, secretName, resourceVersion, cfmpData):
        ...
        if event_type == "ADDED":
            ...
            if secretExists == True:
                ...
                if certExists == False:
                    ...
                    update_post_cert_details(collect_response, domain, secretName, resourceVersion, cfmpData)
                ...
                collect_dict = {
                    'sectigo_ssl_cert_ssl_id': 1874599, #enroll_response["ssl_id"], 
                    'sectigo_ssl_cert_format_type': 'x509CO', 
                    'sectigo_loop_period': 30, 
                    'sectigo_max_timeout': 6000
                }
